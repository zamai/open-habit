...
APP_ID = '6808947599'
WHAT_TO_TEST = os.environ.get('WHAT_TO_TEST', 'Shared Habits now show Invitations, Invite a Member, and Stop Sharing in Edit Habit. The Members section also sits below the calendar in Habit Detail. Please check these sharing flows.')
